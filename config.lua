...
Config = {
	...
	Ammotypes                = {
		["416676503"] = { "AMMO_PISTOL", "AMMO_PISTOL_EXPRESS", "AMMO_PISTOL_EXPRESS_EXPLOSIVE",
		...
		["-1101297303"] = { "AMMO_REVOLVER", "AMMO_REVOLVER_EXPRESS", "AMMO_REVOLVER_EXPRESS_EXPLOSIVE",
			"AMMO_REVOLVER_HIGH_VELOCITY", "AMMO_REVOLVER_SPLIT_POINT", "AMMO_SHOTGUN",
		...
		["-1212426201"] = { "AMMO_RIFLE", "AMMO_RIFLE_EXPRESS", "AMMO_RIFLE_EXPRESS_EXPLOSIVE",
		...
		["1548507267"] = { "AMMO_THROWING_KNIVES", "AMMO_TOMAHAWK", "AMMO_POISONBOTTLE", "AMMO_BOLAS",
			"AMMO_BOLAS_HAWKMOTH",
